...
# Legacy path: `zip` bundles the *deployed* copy from the QGIS profile
# directory, not a git export, so it keeps the unversioned name it has
# always had. Prefer `make package` for anything shipped.
upload: zip
	@echo
	@echo "-------------------------------------"
